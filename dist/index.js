...
const rest = new rest_1.REST({ version: "9" }).setToken(config_json_1.default.token);
...
Promise.all(ready_promises).then(client.login.bind(client, config_json_1.default.token));
